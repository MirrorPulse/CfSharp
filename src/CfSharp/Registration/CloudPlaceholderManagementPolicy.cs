...
/// </remarks>
[Flags]
public enum CloudPlaceholderManagementPolicy
{
    /// <summary>Restricts placeholder management to the connected provider.</summary>
    ProviderOnly = 0x00000000,
    ...
    ConvertUnrestricted = 0x00000002,
