...
/// </summary>
/// <remarks>
/// Content modification always clears the in-sync state. These values control additional
/// metadata tracking and may be combined independently for files and directories.
/// </remarks>
[Flags]
public enum CloudInSyncPolicy : uint
{
    ...
    /// <summary>Tracks every file metadata category recognized by Windows.</summary>
    TrackFileAll = 0x0055550f,

    /// <summary>Tracks every directory metadata category recognized by Windows.</summary>
    TrackDirectoryAll = 0x00aaaaf0,

    /// <summary>Tracks every file and directory metadata category recognized by Windows.</summary>
    TrackAll = 0x00ffffff,

    /// <summary>Preserves in-sync state for changes made by the connected provider.</summary>
    PreserveForSyncEngine = 0x80000000,
}
